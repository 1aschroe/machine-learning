...
$ \sum_{i,j=1}^n c_i c_j K_1(x_i,x_j) \geq 0 $ and $ \sum_{i,j=1}^n c_i c_j K_2(x_i,x_j) \geq 0 $
holds.\\
With  
\[ \sum_{i,j=1}^n c_i c_j K_1(x_i,x_j) + \sum_{i,j=1}^n c_i c_j K_2(x_i,x_j) = \sum_{i,j=1}^n c_i c_j (K_1(x_i,x_j) + K_2(x_i,x_j)) \geq 0 \]
