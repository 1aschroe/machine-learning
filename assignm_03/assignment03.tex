...
\begin{align*}
  \| Y-X (tw_1 + (1-t)w_2) \|^2 =& \langle Y-X (tw_1 + (1-t)w_2), Y-X (tw_1 + (1-t)w_2) \rangle \\
  =& \langle t(Y-X w_1) + (1-t)(Y-X w_2), t(Y-X w_1) + (1-t)(Y-X w_2) \rangle \\
  =& \langle t(Y-X w_1), t(Y-X w_1) + (1-t)(Y-X w_2) \rangle + \langle (1-t)(Y-X w_2), t(Y-X w_1) + (1-t)(Y-X w_2) \rangle \\
  =& \langle t(Y-X w_1), t(Y-X w_1) \rangle + \langle t(Y-X w_1), (1-t)(Y-X w_2) \rangle + \langle (1-t)(Y-X w_2), t(Y-X w_1) \rangle + \langle (1-t)(Y-X w_2), (1-t)(Y-X w_2) \rangle \\
