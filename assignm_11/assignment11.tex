...
\item [Rewards-Funktion] Entfernung der Lande-Position des Pfannkuchens vom Zentrum der Pfanne. Drehung des Pfannkuchens (Hat er sich gedreht, wie oft?): Position geht über Gauß-Funktion mit kleinem Faktor ein. Einmaliges Wenden bringt 1000, zweimaliges Wenden 1100 usw.
...
\subsection*{Frage}
Ist das Reinforcement-Learning-Framework für die Repräsentation aller zielgerichteten Aufgaben der Learning-Theory adäquat? Versuchen Sie, eine klare Ausnahme zu finden, für die RL offensichtlich fehlschlagen wird.

\subsection*{Antwort}
Nein.

RL ist nicht angebracht, wenn 100 \% zuverlässige Anforderungen gestellt werden (bsp. Flugzeug fliegen), da es keine Garantie gibt, dass RL nicht zu irgend einem Zeitpunkt scheitern wird.
