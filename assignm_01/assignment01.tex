...
\subsection*{Exercise 1}
 ...
 \textbf{7. Plot the training and the test errors. Do results change between different runs? Why?} \\
 ...
 \textbf{9. More training examples. How does the performance of kNN classifier change?} \\
 ...
 \textbf{10. Unbalanced classes. More training examples. How does the performance of kNN classifier change?} \\
 
 The performance of the classifier increases approximately by factor $1/3$ for the test data and by factor 40 for the test data.
